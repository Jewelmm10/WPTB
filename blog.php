...
<head>
   ...
   <!--<< Favcion >>-->
   <link rel="shortcut icon" href="assets/src/img/logo/favicon.png">
   <!--<< Bootstrap min.css >>-->
   <link rel="stylesheet" href="assets/src/library/css/bootstrap.min.css">
   <!--<< Aos animation css >>-->
   <link rel="stylesheet" href="assets/src/library/css/aos.css">
   <!--<< Main.css >>-->
...
<div class="preloader__matias">
   <div class="box text-center">
      <div class="matias mb-10">
         <img src="assets/src/img/banner/banner-man.png" alt="img">
      </div>
         ...
         <div class="header-wrapper">
            <div class="main__logo">
               <a href="index.html" class="logo">
                  <img src="assets/src/img/logo/logo.png" alt="logo">
               </a>
            </div>
                        <ul class="main-menu">
               <li>
            ...
            <div class="blog__bleft__wrapper">
               <div class="blog__bitem mb__cus50" data-aos="fade-up" data-aos-duration="1000">
                  <a href="blog-details.html" class="thumb">
                     <img src="assets/src/img/blog/bblog1.png" alt="img">
                  </a>
                  <div class="content">
               ...
               <div class="blog__bitem mb__cus50" data-aos="fade-up" data-aos-duration="1000">
                  <a href="blog-details.html" class="thumb">
                     <img src="assets/src/img/blog/bblog2.png" alt="img">
                  </a>
                  <div class="content">
                     <span class="bdate d-flex align-items-center gap-1 ptext fz-16">
                        <span class="text-uppercase text-white">
               ...
               <div class="blog__bitem mb__cus50" data-aos="fade-up" data-aos-duration="1000">
                  <a href="blog-details.html" class="thumb">
                     <img src="assets/src/img/blog/bblog3.png" alt="img">
                  </a>
                  <div class="content">
                     <span class="bdate d-flex align-items-center gap-1 ptext fz-16">
                        <span class="text-uppercase text-white">
               ...
               <div class="blog__bitem mb__cus50" data-aos="fade-up" data-aos-duration="1000">
                  <a href="blog-details.html" class="thumb">
                     <img src="assets/src/img/blog/bblog4.png" alt="img">
                  </a>
                  <div class="content">
                     <span class="bdate d-flex align-items-center gap-1 ptext fz-16">
                        <span class="text-uppercase text-white">
                  ...
                  <ul class="recent__post">
                     <li>
                        <a href="blog-details.html" class="recent__innter">
                           <img src="assets/src/img/blog/bsmall1.png" alt="img">
                           <div class="cont__box">
                              <span class="retitle">
                     ...
                     <li>
                        <a href="blog-details.html" class="recent__innter">
                           <img src="assets/src/img/blog/bsmall2.png" alt="img">
                           <div class="cont__box">
                              <span class="retitle">
                     ...
                     <li>
                        <a href="blog-details.html" class="recent__innter">
                           <img src="assets/src/img/blog/bsmall3.png" alt="img">
                           <div class="cont__box">
                              <span class="retitle">
                                 The Main Thing For The 
                                 Designer 
...
<div class="subside__barmenu sub__contact">
   ...
   <div class="sub__contact__wrapper d-grid">
      <a href="index-2.html" class="side-logo">
         <img src="assets/src/img/logo/logo.png" alt="img">
      </a>
      <p>
...
<!--<<  sub side bar custom >>-->
   ...
   <!--<< Jquery Latest >>-->
   <script src="assets/src/library/js/jquery-3.7.0.min.js"></script>
   <!--<< Viewport Js >>-->
   <script src="assets/src/library/js/viewport.jquery.js"></script>
   <!--<< Bootstrap Js >>-->
   <script src="assets/src/library/js/bootstrap.min.js"></script>
   <!--<< Aos animation Js >>-->
   <script src="assets/src/library/js/aos.js"></script>
   <!--<< Nice Select Js >>-->
   <script src="assets/src/library/js/jquery.nice-select.min.js"></script>
   <!--<< Swiper Slide Js >>-->
   <script src="assets/src/library/js/swiper-bundle.min.js"></script>
   <!--<< Swiper Bundle Js >>-->
   <script src="assets/src/library/js/jquery.magnific-popup.min.js"></script>
   <!--<< magnific popup Js >>-->
   <script src="assets/src/library/js/odometer.min.js"></script>
   <!--<< Odometer js Js >>-->
   <script src="assets/src/library/js/wow.min.js"></script>
   <!--<< Wow Animation js >>-->
