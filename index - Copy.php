...
<section class="banner__section">
      ...
      <div class="row g-4">
         <div class="col-lg-8">
            <div class="banner__content">
               ...
               <div class="video__area">
                  <img src="<?php echo get_template_directory_uri(); ?>/assets/src/img/bn-arrow.png" class="vid__arrow" alt="img" class="vid__arrow
                  ">
         ...
         <div class="col-lg-4">
            <div class="banner__thumb" data-aos="fade-up-right" data-aos-duration="300">
               <img src="<?php echo get_template_directory_uri(); ?>/assets/src/img/banner-man.png" alt="man-img">
            </div>
         </div>
      </div>
   </div>
   <div class="banner__leftinfo">
      <div class="left__infomobile">
         <a href="#0">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/src/img/dial.png" alt="img" class="dial" >
         </a>
         <a href="#0">
            (+02)-574-328-301
         </a>
   ...
   <div class="marquee-inner to-left">
       <ul class="marqee-list d-flex">
           <li class="marquee-item">
               <img src="<?php echo get_template_directory_uri(); ?>/assets/src/img/ts1.png" alt="text-slide"> <span class="stroke-text"><img src="<?php echo get_template_directory_uri(); ?>/assets/src/img/ts2.png" alt="text-slide"></span>
               <img src="<?php echo get_template_directory_uri(); ?>/assets/src/img/ts3.png" alt="text-slide"> <span class="stroke-text"><img src="<?php echo get_template_directory_uri(); ?>/assets/src/img/ts4.png" alt="text-slide"></span>
               <img src="<?php echo get_template_directory_uri(); ?>/assets/src/img/ts1.png" alt="text-slide"> <span class="stroke-text"><img src="<?php echo get_template_directory_uri(); ?>/assets/src/img/ts2.png" alt="text-slide"></span>
               <img src="<?php echo get_template_directory_uri(); ?>/assets/src/img/ts3.png" alt="text-slide"> <span class="stroke-text"><img src="<?php echo get_template_directory_uri(); ?>/assets/src/img/ts4.png" alt="text-slide"></span>
               <img src="<?php echo get_template_directory_uri(); ?>/assets/src/img/ts1.png" alt="text-slide"> <span class="stroke-text"><img src="<?php echo get_template_directory_uri(); ?>/assets/src/img/ts2.png" alt="text-slide"></span>
               <img src="<?php echo get_template_directory_uri(); ?>/assets/src/img/ts3.png" alt="text-slide"> <span class="stroke-text"><img src="<?php echo get_template_directory_uri(); ?>/assets/src/img/ts4.png" alt="text-slide"></span>
...
<section class="about__section pt-120 pb-120" id="about">
   <div class="container">
      <div class="personal__head text-center">
         <img src="<?php echo get_template_directory_uri(); ?>/assets/src/img/section-star.png" class="mb-30" alt="star">
         <p class="descrp">
                  ...
                  <div class="row g-4 align-items-lg-start align-items-center">
                     <div class="col-lg-5">
                        <div class="about__onethumb" data-aos="zoom-in" data-aos-duration="500">
                           <img src="<?php echo get_template_directory_uri(); ?>/assets/src/img/personal-infothumb.png" alt="img">
                        </div>
                     </div>
                     <div class="col-lg-7">
                              ...
                              <div class="row g-4">
                                 <div class="col-xxl-6 col-xl-6 col-lg-12 col-md-6">
                                    <div class="abox myskill__item">
                                       <div class="thumb">
                                          <img src="<?php echo get_template_directory_uri(); ?>/assets/src/img/figma.png" alt="img">
                                       </div>
                                       <div class="mys">
